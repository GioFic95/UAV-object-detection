...
# https://github.com/digantamisra98/Mish/tree/master/Mish/Torch
# python test.py --img 640 --conf 0.25 --device cpu --batch 4 --data data/coco128.yaml --weights weights/yolov4s-mish_cpu.pt
